          ...
          <div ref={imgRef} className="hidden md:flex flex-col gap-[16px]">
            {nucleo.fotoPrincipal.src && (
              ...
              >
                ...
                <img src={nucleo.fotoPrincipal.src} alt="" className="absolute inset-0 w-full h-full object-cover" />
                <div className="absolute inset-0" style={{ background:"linear-gradient(to top, rgba(26,43,74,0.75) 0%, transparent 50%)" }} />
                {nucleo.fotoPrincipal.caption && (
            ...
            {nucleo.fotoSecundaria.src && (
              ...
              >
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src={nucleo.fotoSecundaria.src} alt="" className="absolute inset-0 w-full h-full object-cover object-center" />
                <div className="absolute inset-0" style={{ background:"rgba(26,43,74,0.35)" }} />
                {nucleo.fotoSecundaria.caption && (
