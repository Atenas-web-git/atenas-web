...
const subLinks: Record<CategoryKey, Record<string, string>> = {
  ...
  documentos: {
    "Resolución de Pensiones":           "/documentos-institucionales",
    "Contrato de Prestación":            "/documentos-institucionales",
    "Código de Convivencia":             "/documentos-institucionales",
    "Declaración Juramentada":           "/documentos-institucionales",
    "Solicitud de Inasistencia":         "/documentos-institucionales",
    "Ver todos los documentos →":        "/documentos-institucionales",
  },
  servicios: {
