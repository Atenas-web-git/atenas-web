...
export async function POST(req: NextRequest) {
  try {
          ...
          <div style="background: #ffffff; padding: 32px; border: 1px solid #e8e4df; border-top: none; border-radius: 0 0 8px 8px;">
            ...
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 28px;">
              <tr style="border-bottom: 1px solid #f0ece7;">
                ...
                <td style="padding: 10px 0; font-size: 14px; font-weight: 600; color: #1A2B4A;">${s.nombre}</td>
              </tr>
              <tr style="border-bottom: 1px solid #f0ece7;">
              ...
              <tr>
                ...
                <td style="padding: 10px 0; font-size: 14px; font-weight: 600; color: #1A2B4A;">${s.asunto}</td>
              </tr>
            </table>
    ...
    // Envío SECUENCIAL (no en paralelo): varios servidores SMTP rechazan una
    // segunda conexión simultánea desde la misma cuenta. Cada envío es
    // best-effort y no rompe la respuesta del formulario si falla.
    await sendEmail({
      purpose: "contactos",
