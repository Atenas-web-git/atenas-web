...
export default async function InicialPage() {
  ...
  const pagina = await getPagina("academico/niveles/inicial");
    ...
    <>
      ...
      <main>
        ...
        <CTAAdmisionNivel
          ...
          href={c.ctaAdmision?.href ?? "/admisiones/inicial"}
          ...
          secundarioHref={c.ctaAdmision?.secundarioHref ?? "/admisiones/inicial#proceso"}
        />
        )}
