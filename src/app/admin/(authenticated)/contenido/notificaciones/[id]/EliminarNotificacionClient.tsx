...
import { eliminarNotificacionAction, type NotifActionState } from "../actions";

export function EliminarNotificacionClient({
  id,
  titulo,
}: {
  id: string;
  ...
  const [state, action, deleting] = useActionState<NotifActionState, FormData>(
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              style={{
                ...confirmBtn,
                cursor:
                  deleting || confirmText !== titulo ? "not-allowed" : "pointer",
