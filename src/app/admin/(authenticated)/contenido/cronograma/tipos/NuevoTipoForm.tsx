...
import { guardarTipoAction, type CronogramaActionState } from "../actions";

export function NuevoTipoForm() {
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_240px] gap-3">
        <Field label="Nombre" required>
          <input type="text" name="nombre" required placeholder="ej. Deportivo" style={inputStyle} />
        </Field>
